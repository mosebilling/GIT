...
Public Class DOCDPInvoiceWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.DOCDPInvoiceWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDOCDPInvoiceWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DOCDPInvoiceWise = New DOCDPInvoiceWise
        rpt.Site = Me.Site
        Return rpt
    End Function
