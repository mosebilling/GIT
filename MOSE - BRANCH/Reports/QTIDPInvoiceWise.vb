...
Public Class QTIDPInvoiceWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.QTIDPInvoiceWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQTIDPInvoiceWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QTIDPInvoiceWise = New QTIDPInvoiceWise
        rpt.Site = Me.Site
        Return rpt
    End Function
