...
Public Class SODPInvoiceWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.SODPInvoiceWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSODPInvoiceWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SODPInvoiceWise = New SODPInvoiceWise
        rpt.Site = Me.Site
        Return rpt
    End Function
