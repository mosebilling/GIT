...
Public Class STMSUPWithoutValue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.STMSUPWithoutValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSTMSUPWithoutValue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As STMSUPWithoutValue = New STMSUPWithoutValue
        rpt.Site = Me.Site
        Return rpt
    End Function
