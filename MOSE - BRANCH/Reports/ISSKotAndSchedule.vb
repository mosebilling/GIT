...
Public Class ISSKotAndSchedule
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.ISSKotAndSchedule.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedISSKotAndSchedule
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ISSKotAndSchedule = New ISSKotAndSchedule
        rpt.Site = Me.Site
        Return rpt
    End Function
