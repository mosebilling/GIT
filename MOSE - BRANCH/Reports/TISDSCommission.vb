...
Public Class TISDSCommission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.TISDSCommission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTISDSCommission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TISDSCommission = New TISDSCommission
        rpt.Site = Me.Site
        Return rpt
    End Function
