...
Public Class QR1WithoutCost
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMSMP.QR1WithoutCost.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQR1WithoutCost
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QR1WithoutCost = New QR1WithoutCost
        rpt.Site = Me.Site
        Return rpt
    End Function
