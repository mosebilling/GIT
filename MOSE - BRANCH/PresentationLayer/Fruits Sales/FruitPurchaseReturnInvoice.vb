...
Public Class FruitPurchaseReturnInvoice
            ...
            If dtInvCmn.Rows.Count > 0 Then
                If IsReturn Then
                    ...
                    If Val(dtInvCmn(0)("ccustid") & "") = 0 Then
                        creditsupplierACC = 0 ' Val(ItmInvCmnTb(0)("CSCode" & ""))
                    Else
                        creditsupplierACC = Val(dtInvCmn(0)("ccustid" & ""))
                        'txtCashCustomer.Enabled = False
                    End If
                    If fSelectRtnItem Is Nothing Then
                        fSelectRtnItem = New SalesPurchaseReturnItemsFrm
                    End If
                    loadCarriers(IIf(creditsupplierACC > 0, creditsupplierACC, dtInvCmn(0)("CSCode")), 0)
...
chkagain:
    ...
    Private Sub UpdateAccounts(ByVal TrId As Long, ByVal TDrAmt As Double)
        ...
        End If
        'Debit Entry
        setAcctrDetValue(LinkNo, Val(txtSuppAlias.Tag), Trim(txtReference.Text), EntRef, CDbl(lblNetAmt.Text), "", Strings.Left(txtJob.Tag, 50), 0, 0, "", _
...
u:
    ...
    Private Sub SetGridHeadCarrier()
        ...
        With grdcarrier
            ...
            .Columns(constCarrierCurrentVoucher).HeaderText = "Returned"
...
n:
    ...
    Private Sub saveCarrier(ByVal trid As Long)
        Dim i As Integer
        Dim qry As String
        Dim trRemarks As String = "TRANSACTION FROM PURCHASE RETURN"
        With grdcarrier
            For i = 0 To .RowCount - 1
                ...
                trid & "," & Val(.Item(constcustomerid, i).Value) & "," & Val(.Item(constcarrierid, i).Value) & "," & Val(.Item(constCarrierCurrentVoucher, i).Value) & ",0," & _
    ...
    Private Sub calculateCarrier()
        ...
        With grdcarrier
            For i = 0 To .RowCount - 1
                ...
                cqty = Val(.Item(constoldbalance, i).Value) - cqty
                .Item(constcarrierbal, i).Value = cqty
                'MsgBox(grdcarrier(constcarrierbal, 0).Value)
                'MsgBox(cqty)
            Next
        End With
