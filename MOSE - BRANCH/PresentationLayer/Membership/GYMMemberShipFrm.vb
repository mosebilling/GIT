...
#End Region
    ...
    Private Sub GYMMemberShipFrm_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        txtcustomer.Focus()
    End Sub

    Private Sub GYMMemberShipFrm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub GYMMemberShipFrm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        AddNew()
        setGridHead()
        chkenabledate.Checked = True
        cldrEnddate.Value = DateAdd(DateInterval.Day, Val(txtafter.Text), DateValue(cldrStartDate.Value))
