...
Public Class CustomerDeliverOrderFrm
...
#Region "Class Objet declarations"
    ...
    Private _objDoc As New clsDocCmn
#End Region
...
#End Region
    ...
    Public Sub CheckNLoad(Optional ByVal FromTrId As Long = 0)
        ...
        Else
            InvList = _objcmnbLayer._fldDatatable("SELECT Docid FROM DocCmnTb  WHERE Doctype = 'DOC' AND DNO = " & Val(numVchrNo.Text) & _
...
Quit:
    ...
    Private Sub NextNumber()
        ...
        getVrsDet(0, "DOC", vrPrefix, vrVoucherNo, vrAccountNo1, vrAccountNo2)
        If Not isModi Then
...
nxt:
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        If btnModify.Text = "&Modify" Then
            ...
            If userType Then
                btnupdate.Tag = IIf(getRight(213, CurrentUser), 1, 0)
                btndelete.Tag = IIf(getRight(214, CurrentUser), 1, 0)
            Else
                btnupdate.Tag = 1
                btndelete.Tag = 1
            End If
    ...
    Private Sub saveTrans()
        ...
        If Not isModi Then
chkagain:
            If Not CheckNoExists(txtprefix.Text, Val(numVchrNo.Text), "DOC", "Document") Then
        ...
        If Not isModi Then
            ...
            numVchrNo.Tag = numVchrNo.Text
            txtprefix.Text = SetNextVrNo(numVchrNo, 0, "DOC", "DocType = 'DOC' AND DNO = ", False, False, True, 0, txtprefix.Text)
        End If
        ChgId = False
        chgPost = False
        AddNewClick()
        MsgBox("Delivery Note is succesfully posted with DOC. # " & numPrintVchr.Text & ".", MsgBoxStyle.Information)
        numVchrNo.Tag = ""
    End Sub
...
u:
    ...
    End Sub
    Private Sub CustomerDeliverOrderFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            FormLoad()
            ...
            Else
                AddNewClick()
                If userType Then
                    btnupdate.Tag = IIf(getRight(212, CurrentUser), 1, 0)
                Else
                    btnupdate.Tag = 1
                End If
                btndelete.Text = "Clear"
